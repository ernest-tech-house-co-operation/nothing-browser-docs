...
Spoof browser fingerprints to avoid tracking and bypass detection. Piggy provides built-in fingerprint spoofing that works at the **engine level** — before any page JavaScript runs.
...
- [Identity & Profile](./identity-profile) — Persistent fingerprint identity
