      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '🔥 exposeFunction (RPC)', link: '/guide/piggy/expose' },
            ...
            { text: '🧠 Human Mode', link: '/guide/piggy/human' },
            { text: '🕸️ Network Capture', link: '/guide/piggy/intercept' },
            ...
            { text: '💾 Data Storage (site.store)', link: '/guide/piggy/storage' },
            { text: '🌐 Remote Deployment', link: '/guide/piggy/remote-deployment' },
            { text: '🚀 Proxy Support', link: '/guide/piggy/proxy' },
            { text: '💾 Session Persistence (Opt-in)', link: '/guide/piggy/session' },
            ...
            { text: 'Captcha', link: '/guide/piggy/captcha' },
            { text: 'Capture', link: '/guide/piggy/capture' },
            { text: 'Core', link: '/guide/piggy/core' },
            { text: '❓ FAQ', link: '/guide/piggy/faq' }
          ]
        },
        {
